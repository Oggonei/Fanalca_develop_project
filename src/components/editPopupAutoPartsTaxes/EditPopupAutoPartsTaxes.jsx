...
const EditPopupAutoPartsTaxes = ({ popup, editData, itemId }) => {
        ...
        <>
          <div className="h-screen w-screen bg-black opacity-100 absolute top-0 left-0 flex justify-center items-center" />
            <div className="h-screen w-screen absolute top-0 left-0 flex justify-center items-center">
                ...
                >
                    <p className="text-xl mb-2">Editar impuestos autopartes</p>
                    <div className='w-full flex flex-wrap flex-row'>
                        ...
                        func={updateVal}
                        value={data.clase_iva_rta_ser_4}
                        />
                        <Input
                        type="user"
                        ...
                        func={updateVal}
                        value={data.valor_iva_rta_ser_4}
                        />
                        <Input
                        type="user"
...
export default EditPopupAutoPartsTaxes